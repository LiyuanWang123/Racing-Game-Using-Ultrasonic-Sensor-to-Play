...
CONFIG.CLK_DOMAIN {clock_rtl} \
  ...
  set sensor [ create_bd_port -dir I -from 0 -to 0 sensor ]
  set sensor2 [ create_bd_port -dir I -from 0 -to 0 sensor2 ]
...
CONFIG.C_INTERRUPT_PRESENT {1} \
  ...
  # Create instance: sensor, and set properties
  set sensor [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 sensor ]
  set_property -dict [ list \
CONFIG.C_ALL_INPUTS {1} \
CONFIG.C_GPIO_WIDTH {1} \
CONFIG.C_INTERRUPT_PRESENT {1} \
  ...
  # Create instance: sensor2, and set properties
  set sensor2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 sensor2 ]
  set_property -dict [ list \
CONFIG.C_ALL_INPUTS {1} \
CONFIG.C_GPIO_WIDTH {1} \
CONFIG.C_INTERRUPT_PRESENT {1} \
...
CONFIG.C_INTERRUPT_PRESENT {1} \
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M07_AXI [get_bd_intf_pins microblaze_0_axi_periph/M07_AXI] [get_bd_intf_pins spi_dc/S_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M08_AXI [get_bd_intf_pins microblaze_0_axi_periph/M08_AXI] [get_bd_intf_pins spi/AXI_LITE]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M09_AXI [get_bd_intf_pins microblaze_0_axi_periph/M09_AXI] [get_bd_intf_pins sensor/S_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M10_AXI [get_bd_intf_pins microblaze_0_axi_periph/M10_AXI] [get_bd_intf_pins sensor2/S_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M11_AXI [get_bd_intf_pins axi_timer_1/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M11_AXI]
  ...
  connect_bd_net -net axi_timer_1_interrupt [get_bd_pins axi_timer_1/interrupt] [get_bd_pins microblaze_0_xlconcat/In7]
  ...
  connect_bd_net -net gpio_io_i_4 [get_bd_ports sensor] [get_bd_pins sensor/gpio_io_i]
  connect_bd_net -net gpio_io_i_5 [get_bd_ports sensor2] [get_bd_pins sensor2/gpio_io_i]
  ...
  connect_bd_net -net rst_mig_7series_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_timer_1/s_axi_aresetn] [get_bd_pins mdm_1/S_AXI_ARESETN] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/M06_ARESETN] [get_bd_pins microblaze_0_axi_periph/M07_ARESETN] [get_bd_pins microblaze_0_axi_periph/M08_ARESETN] [get_bd_pins microblaze_0_axi_periph/M09_ARESETN] [get_bd_pins microblaze_0_axi_periph/M10_ARESETN] [get_bd_pins microblaze_0_axi_periph/M11_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins push/s_axi_aresetn] [get_bd_pins rst_mig_7series_0_100M/peripheral_aresetn] [get_bd_pins sensor/s_axi_aresetn] [get_bd_pins sensor2/s_axi_aresetn] [get_bd_pins spi/s_axi_aresetn] [get_bd_pins spi_dc/s_axi_aresetn] [get_bd_pins twist/s_axi_aresetn]
  connect_bd_net -net sensor2_ip2intc_irpt [get_bd_pins microblaze_0_xlconcat/In6] [get_bd_pins sensor2/ip2intc_irpt]
  connect_bd_net -net sensor_ip2intc_irpt [get_bd_pins microblaze_0_xlconcat/In5] [get_bd_pins sensor/ip2intc_irpt]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40060000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs sensor2/S_AXI/Reg] SEG_sensor2_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40050000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs sensor/S_AXI/Reg] SEG_sensor_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs spi/AXI_LITE/Reg] SEG_spi_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40040000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs spi_dc/S_AXI/Reg] SEG_spi_dc_Reg
