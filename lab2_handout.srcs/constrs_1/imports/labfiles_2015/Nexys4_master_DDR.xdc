...
#set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { setTest }]; #IO_L24N_T3_RS0_15 Sch=sw[0]
...
## LEDs NEXYs4 Original Constraints ... for use with non DDR board
...
##7 segment display Nexys4 Original
...
##Pmod Header JA Nexys4 Original
##Bank = 15, Pin name = IO_L1N_T0_AD0N_15,					Sch name = JA1
#set_property PACKAGE_PIN B13 [get_ports {lcddriver_tri_io[0]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {lcddriver_tri_io[0]}]
...
#set_property PACKAGE_PIN G13 [get_ports {lcddriver_tri_io[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {lcddriver_tri_io[1]}]
##Bank = 15, Pin name = IO_L20N_T3_A19_15,					Sch name = JA8
#set_property PACKAGE_PIN C17 [get_ports {lcddriver_tri_io[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {lcddriver_tri_io[2]}]
##Bank = 15, Pin name = IO_L21N_T3_A17_15,					Sch name = JA9
#set_property PACKAGE_PIN D18 [get_ports {lcddriver_tri_io[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {lcddriver_tri_io[3]}]
##Bank = 15, Pin name = IO_L21P_T3_DQS_15,					Sch name = JA10
#set_property PACKAGE_PIN E18 [get_ports {lcddriver_tri_io[4]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {lcddriver_tri_io[4]}]
