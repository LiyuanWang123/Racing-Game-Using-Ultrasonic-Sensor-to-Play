...
HD_PWD='C:/Users/liyuan/Desktop/lab2b/lab2_handout.runs/system_twist_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_twist_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_twist_0.tcl
